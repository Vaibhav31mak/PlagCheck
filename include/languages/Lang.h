...
public:
	...
	virtual const struct PlagCheck::Idf* getPreprocessCommands() = 0;
	virtual const struct PlagCheck::Idf* getKeywords() = 0;
...
protected:
	...
	static const struct PlagCheck::Idf Idf_PreprocessCommands[];
	static const struct PlagCheck::Idf Idf_Keywords[];
...
public:
	...
	virtual const struct PlagCheck::Idf* getPreprocessCommands() override {
		return T::Idf_PreprocessCommands;
	};
	virtual const struct PlagCheck::Idf* getKeywords() override {
